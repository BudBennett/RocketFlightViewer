...
class StatsWidget extends StatelessWidget {
  ...
  Widget _buildSingle(BuildContext context) {
    ...
    String armAlt = '—';
    if (stats.groundRawPress != 0) {
      final m = lps22hb.altitudeMslM(stats.groundRawPress, stats.baroType);
                ...
                children: [
                  TableRow(
                    ...
                    children: [
                      ...
                      headerCell('Δ (A−B)', color: secondaryTextColor(context)),
                    ],
                  ),
                  dataRow('Flight time',
                  ...
                  dataRow('Burnout',
                      _ms(stats.timeBurnoutMs),
                      _ms(s2.timeBurnoutMs),
