...
class _ConfigWidgetState extends State<ConfigWidget> {
  ...
  void _save() {
    ...
    widget.controller.setConfig(val, _lpfSetting, widget.controller.configFastMaxS ?? 30, widget.controller.configOdrSel ?? 0x02, widget.controller.configLaunchConfirmSamples ?? 3);
  }
